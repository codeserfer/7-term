...
* Используется AUTH PLAIN авторизация
*/
...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	try
	{
		...
		tcp->SendData("AUTH PLAIN\r\n");
		cout << "AUTH PLAIN" << endl;
		cout << tcp->ReceiveData() << endl;

		cout << endl << endl;


		char const* buffer = "\0stud_08\0stud_08";
		int bufferLength = 16;
		tcp->SendData(base64_encode(buffer, bufferLength) + "\r\n");
		cout << tcp->ReceiveData() << endl;

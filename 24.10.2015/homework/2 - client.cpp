/*
* Клиент отправляет цепочку чисел, разделенных пробелами.
* И также отправляется разделитель.
* Сервер возвращает строку, состоящую из отправленных чисел, разденных разделителем.
*/
